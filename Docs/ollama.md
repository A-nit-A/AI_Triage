...
* **Catálogo de modelos:** Permite descargar los modelos de código abierto más avanzados y populares del momento, como **Llama 3** (de Meta), **Mistral**, **Gemma** (de Google) o **Phi** (de Microsoft).
